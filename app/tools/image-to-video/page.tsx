  ...
  return (
    <main style={{ maxWidth: 760, margin: "0 auto", padding: 24 }}>
      ...
      <p style={{ opacity: 0.8, marginTop: 0 }}>
        Upload an image and animate it with a prompt.
      </p>
      ...
      >
        ...
        <div style={{ marginTop: 12 }}>
          ...
          <textarea
            ...
            placeholder="Example: Gentle cinematic motion, realistic lighting, subtle camera push-in."
            rows={4}
            style={{
              width: "100%",
              padding: 12,
        ...
        >
          ...
          <button onClick={onGenerate} disabled={loading} style={{ ...buttonStyle, marginLeft: "auto" }}>
